            	...
            	<div class="module">
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $bid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                   <td class="f"><?php echo e($b->pid); ?></td>
                                   <td class="tr"><span><?php echo e($b->title); ?></span></td> 
                                   <td class="tr"><?php echo e($b->money/100); ?></td> 
                                   <td class="tr"><?php echo e(date('Y-m-d'),$b->pubtime); ?></td> 
                                     <td class="tr">
                                        <?php if($b->status == 1): ?>
                                        招标中
