            	...
            	<div class="module">
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $grows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="f"><?php echo e($g->pid); ?></td>
                                   <td class="tr"><span><?php echo e($g->title); ?></span></td> 
                                   <td class="tr"><?php echo e($g->amount/100); ?></td> 
