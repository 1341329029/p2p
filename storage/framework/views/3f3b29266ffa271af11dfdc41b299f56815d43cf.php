            	...
            	<div class="module">
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $hks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                   <td class="f"><?php echo e($h->pid); ?></td>
                                   <td class="tr"><span><?php echo e($h->title); ?></span></td> 
                                   <td class="tr"><?php echo e($h->amount/100); ?></td> 
                                   <td class="tr"><?php echo e($h->paydate); ?></td> 
                                     <td class="tr">
                                        <?php if($h->status == 0): ?>
                                        <a href="/<?php echo e($h->pid); ?>">还款</a>
                                        <?php else: ?>
                                        已还
                                        <?php endif; ?>
                                    </td> 
                            ...
                            <div class="t_foot">
                                ...
                                <div class="r">
                            	<div class="fy">
                                	<?php echo e($hks->appends(['sort'=>'cart'])->fragment(str_random())->links()); ?>
