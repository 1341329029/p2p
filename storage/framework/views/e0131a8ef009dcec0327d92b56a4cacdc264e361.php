...
<div class="niwdoawi_top mw_1180">
    <div class="header w1190 clearfix">
        ...
        <div class="fr login clearfix">
            ...
            <div class="login_bt"><input value="" id="log_userid" type="hidden"><input value="itbool" id="log_username" type="hidden"><em class="fff fs_12">您好，</em><a href="#" rel="nofollow" class="hello"><?php echo e(Auth::user()->name); ?></a><a href="#" id="loginOut" class="hello">退出</a></div>
                        <!-- <?php endif; ?> -->
                        <?php endif; ?>
            <dl>
 ...
 <div class="application">
        ...
        <div class="delCon">
            ...
            <div class="iptBox">
                ...
                <p id="ageError" style="display: block;" class="error"><?php echo e($errors->first('age')); ?></p>
                                <?php endif; ?>
            </div>
            ...
            <div class="iptBox">
                ...
                <p style="display: block;" id="amountError" class="error"><?php echo e($errors->first('money')); ?></p>
                                <?php endif; ?>
            </div>
            <div class="iptBox">
                <span>手机号码</span>
                ...
                <p id="mobileError" style="display: block;" class="error"><?php echo e($errors->first('mobile')); ?></p>
                                <?php endif; ?>
            </div>
            <div class="iptBox">
                <span class="message">图形验证码</span>
                <input class="short" name="imgcode" id="imgcode" placeholder="请输入图形验证码" type="text">
                <img src="<?php echo e(url('captcha')); ?>" name="imgc" id="imgc" alt="换一张" class="get-code" height="36" width="80">
                                <?php if($errors->has('imgcode')): ?>
                <p id="imgcodeError" style="display: block;" class="error"><?php echo e($errors->first('imgcode')); ?></p>
                                <?php endif; ?>
            </div>
            <div class="iptBox">
