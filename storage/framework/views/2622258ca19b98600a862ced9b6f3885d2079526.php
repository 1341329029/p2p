                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            <li class="w1">
                                ...
                                <p class="fc_orange airal"><em class="fs_28"><?php echo e($p->rate); ?></em>
                                    <em class="fs_18">%</em>
                                </p>
                            </li>
                            <li class="w2">
                                <p class="fc_9 mb_5">期限</p>
                                <p class="fc_6"><em class="fs_18"><?php echo e($p->hrange); ?></em>个月</p>
                            </li>
                            <li class="w3">
                                <p class="fc_9 mb_5">投资金额 </p>
                                <p class="fc_6 airal fs_18"><?php echo e($p->recive/100); ?></p> 
                            </li>
                             <li class="w4">
                                <span class="b_jingdu b_jd<?php echo e(sprintf("%d",($p->recive/$p->money)*100)); ?>"><?php echo e(sprintf('%.2f',($p->recive/$p->money)*100)); ?>%</span>
                            </li>
                            <li class="w5">
                                    <a class="btn btnSize_1 btn_orange" href="<?php echo e(url('touzi',$p->pid)); ?>">立即投标</a>
                            </li>
                        </ul>
                    </div>
                    <!--1 e -->
