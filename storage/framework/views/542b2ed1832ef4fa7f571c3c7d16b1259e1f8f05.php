                 ...
                 <?php echo e(csrf_field()); ?>               
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $pro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                   <td class="f"><?php echo e($p->pid); ?></td>
                                   <td><?php echo e(date('Y-m-d',$p->pubtime)); ?></td> 
                                   <td class="tr"><span><?php echo e($p->name); ?></span></td>
                                   <td class="tr"><?php echo e($p->money/100); ?></td> 
                                   <td class="tr"><?php echo e($p->mobile); ?></td>
                                   <td class="">
                                   <?php if($p->status == 0): ?>
                                   待审核
                                   <?php else: ?>
                                   已通过
                                   <?php endif; ?></td>
                                   <td class="l"><a href="<?php echo e(url('check',$p->pid)); ?>">审核</a></td>
                                </tr>
